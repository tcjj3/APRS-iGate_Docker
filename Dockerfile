...
RUN export DIR_TMP="$(mktemp -d)" \
  ...
  && apt-get install --no-install-recommends -y apt-get -y install git build-essential cmake libusb-1.0-0-dev sox libtool autoconf automake libfftw3-dev qt4-qmake libpulse-dev libx11-dev python-pkg-resources bc checkinstall \
  || apt-get install --no-install-recommends -y apt-get -y install git build-essential cmake libusb-1.0-0-dev sox libtool autoconf automake libfftw3-dev qt4-qmake libpulse-dev libx11-dev python-pkg-resources bc \
